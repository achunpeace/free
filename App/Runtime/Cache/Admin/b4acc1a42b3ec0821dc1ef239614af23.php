                  ...
                  <div class="tile-body color transparent-black rounded-corners">
                    ...
                    <form action="" method="post">
                      <table  class="table table-datatable table-custom" id="basicDataTable" >
                        <thead>
                          <tr id="xlr">
                          <th class="sort-alpha" style="font-size:18px; width:10px; font-weight:900; color:pink;"><input type="submit" value="全部删除"></th>
                            <th class="sort-alpha" style="font-size:18px; font-weight:900; color:pink;">类名</th>
                            <th class="sort-alpha" style="font-size:18px;">PID</th>
                        ...
                        <tbody id="tbody">
                          <!-- 第一个表格 -->
                          <?php if(is_array($cates['child'])): foreach($cates['child'] as $key=>$val): ?><tr class="gradeA" >
                                  ...
                                  <td class="actions text-center" style="text-align:center;">
                                    ...
                                    <a class="edit" href="<?php echo U('Attr/index',"cate_id=$val[id]");?>">属性</a>
                                  </td>
              ...
              for(var i in cate){
                  ...
                  str +='<td><input name = "id[]" class="idd" type="checkbox" value = "'+cate[i].id+'">'+cate[i].id+'</td>';
                   ...
                   if(cate[i].child==1){
                    ...
                    str +='<a class="edit" href="/index.php/Admin/Cate/edit/id/'+cate[i].id+'">编辑</a>';
                    str +='<i class="icon-trash"></i>';
                    str +='<a class="delete" onclick="return confirm('+'"确定要删除吗"'+')" href="/index.php/Admin/Cate/delete/id/'+cate[i].id+'">删除</a>';
                    str +=  '<i class="icon-arrow-right"></i>';
                    str += '<a class="" href="/index.php/Admin/Attr/index/cate_id/'+cate[i].id+'">属性</a>';
                    str +='</td>';
                    str +='</tr>';
                      }
                      // alert(str);
