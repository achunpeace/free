                    ...
                    <form action="" method="post">
                      <table  class="table table-datatable table-custom" id="basicDataTable" >
                        <thead>
                          ...
                          <th class="sort-alpha" style="font-size:18px; font-weight:900; color:pink;">角色名</th>
                            <th class="sort-alpha" style="font-size:18px; font-weight:900; color:pink;">角色规则</th>  
                            <th class="sort-alpha" style="font-size:18px; font-weight:900; color:pink; text-align:center;">操作</th>
                          </tr>
                        </thead>
                        <tbody id="tbody">
                          <!-- 第一个表格 -->
                          <?php if(is_array($role)): foreach($role as $key=>$val): ?><tr class="gradeA" >
                                  <td><input name = "id[]" class="idd" type = "checkbox" value="<?=$val['id']?>"><?php echo ($val['id']); ?></td>
                                  <td class="role_name"><?php echo ($val['role_name']); ?></td>
                                  <td class="rules"><?php echo ($val['rules']); ?></td>   
              ...
              for(var i in cate){
                  ...
                  str +='<td><input name = "id[]" class="idd" type="checkbox" value = "'+cate[i].id+'">'+cate[i].id+'</td>';
                   ...
                   if(cate[i].child==1){
                    ...
                    str +='<a class="edit" href="/index.php/Admin/Role/edit/id/'+cate[i].id+'">编辑</a>';
                    str +='<i class="icon-trash"></i>';
                    str +='<a class="delete" onclick="return confirm('+'"确定要删除吗"'+')" href="/index.php/Admin/Role/delete/id/'+cate[i].id+'">删除</a>';
