                    ...
                    <form action="" method="post">
                      <table  class="table table-datatable table-custom" id="basicDataTable" >
                        <thead>
                          ...
                          <th class="sort-alpha" style="font-size:18px; font-weight:900; color:pink;">品牌名称</th>
                            <th class="sort-alpha" style="font-size:18px; font-weight:900; color:pink;">品牌LOGO</th>
                            <th class="sort-alpha" style="font-size:18px;">品牌官网</th>
                        ...
                        <tbody id="tbody">
                          <!-- 第一个表格 -->
                          <?php if(is_array($brand)): foreach($brand as $key=>$val): ?><tr class="gradeA" >
                                  <td><input name = "id[]" class="idd" type = "checkbox" value = "<?=$val['id']?>"><?php echo ($val['id']); ?></td>
                                  <td class="name"><?php echo ($val['name']); ?></td>
                                  <td class="name"><img style="width:150px; height:100px;" src="/Public/Uploads/<?php echo ($val['logo']); ?>"></td>
                                  <td class="pid"><a href="<?php echo ($val['url']); ?>"><?php echo ($val['url']); ?></a></td>
              ...
              for(var i in cate){
                  ...
                  str +='<td><input name = "id[]" class="idd" type="checkbox" value = "'+cate[i].id+'">'+cate[i].id+'</td>';
                   ...
                   if(cate[i].child==1){
                    ...
                    str +='<a class="edit" href="/index.php/Admin/Brand/edit/id/'+cate[i].id+'">编辑</a>';
                    str +='<i class="icon-trash"></i>';
                    str +='<a class="delete" onclick="return confirm('+'"确定要删除吗"'+')" href="/index.php/Admin/Brand/delete/id/'+cate[i].id+'">删除</a>';
