              ...
              <div class="col-md-6">
                ...
                <section class="tile color transparent-black">
                  ...
                  <div class="tile-body">
                    ...
                    <form action="<?php echo U('editData',array('id'=>$one['id']));?>" method="post" class="form-horizontal" role="form" enctype="multipart/form-data">
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-sm-8">
                          <input  class="form-control" id="input01" name="url" value="<?php echo ($one['url']); ?>">
                        </div>
                      </div>
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-sm-8">
                          <input type="file" id="input01" name="logo" value="<?php echo ($one['logo']); ?>">
                        </div>
                      </div>
