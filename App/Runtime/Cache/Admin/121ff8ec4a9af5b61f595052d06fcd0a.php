                    ...
                    <form action="" method="post">
                      <table  class="table table-datatable table-custom" id="basicDataTable" >
                        <thead>
                          ...
                          <th class="sort-alpha" style="font-size:18px; font-weight:900; color:pink;">规则名</th>
                          <th class="sort-alpha" style="font-size:18px; font-weight:900; color:pink;">规则路径</th>  
                          <th class="sort-alpha" style="font-size:18px; font-weight:900; color:pink;">pid</th> 
                          <th class="sort-alpha" style="font-size:18px; font-weight:900; color:pink; text-align:center;">操作</th>
                          </tr>
                        </thead>
                        <tbody id="tbody">
                          <!-- 第一个表格 -->
                          <?php if(is_array($rule)): foreach($rule as $key=>$val): ?><tr class="gradeA" >
                                  <td><input name = "id[]" class="idd" type = "checkbox" value="<?=$val['id']?>"><?php echo ($val['id']); ?></td>
                                  <td class="rule_name"><?php echo ($val['rule_name']); ?></td>
                                  <td class="url"><?php echo ($val['url']); ?></td>  
