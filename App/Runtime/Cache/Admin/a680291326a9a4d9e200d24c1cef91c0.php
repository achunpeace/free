              ...
              <div class="col-md-6">
                ...
                <section class="tile color transparent-black">
                  ...
                  <div class="tile-body">
                    ...
                    <form action="<?php echo U('addRule');?>" method="post" class="form-horizontal" role="form">
                      
                      <div class="form-group">
                        <label for="input01" class="col-sm-4 control-label">规则名</label>
                        <div class="col-sm-8">
                          <input  class="form-control" id="input01" name="rule_name" >
                        </div>
                      </div>

                      <div class="form-group">
                        <label for="input01" class="col-sm-4 control-label">规则路径</label>
                        <div class="col-sm-8">
                          <input  class="form-control" id="input01" name="url" placeholder="例如 Admin/Menus/index">
                        </div>
                      </div>
                      
                      <div class="form-group">
                        <label for="input01" class="col-sm-4 control-label">是否开启此权限</label>
                        <div class="col-sm-8">
                      ...
                      <div class="form-group">
                        <label for="input01" class="col-sm-4 control-label">PID</label>
                        <div class="col-sm-8">
                          <input type="text" id="input01" name="pid">
                        </div>
                      </div>
