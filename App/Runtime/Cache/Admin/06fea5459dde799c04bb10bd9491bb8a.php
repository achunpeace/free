                    ...
                    <form action="" method="post">
                      <table  class="table table-datatable table-custom" id="basicDataTable" >
                        <thead>
                          ...
                          <a href="<?php echo U('add',"cate_id=$cate_id");?>"><input type="button" value="添加属性"></a>
                          <input type="submit" value="全部删除">
                          </th>
                            <th class="sort-alpha" style="font-size:18px; font-weight:900; color:pink;">属性名</th>
                            <th class="sort-alpha" style="font-size:18px; font-weight:900; color:pink; text-align:center;">操作</th>
                          </tr>
                        </thead>
                        <tbody id="tbody">
                          <!-- 第一个表格 -->
                          <?php if(is_array($prop)): foreach($prop as $key=>$val): ?><tr class="gradeA" >
                                  <td><input name = "id[]" class="idd" type = "checkbox" value = "<?=$val['id']?>"><?php echo ($val['id']); ?></td>
                                  <td class="name"><?php echo ($val['attr_name']); ?></td>
                                  <td class="actions text-center" style="text-align:center;">
                                    <i class="icon-edit"></i>
                                    <a class="edit" href="<?php echo U('edit');?>?cate_id=<?php echo ($cate_id); ?>&id=<?php echo ($val[id]); ?>">编辑</a>
