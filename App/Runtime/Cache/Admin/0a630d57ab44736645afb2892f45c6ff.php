              ...
              <div class="col-md-6">
                ...
                <section class="tile color transparent-black">
                  ...
                  <div class="tile-body">
                    ...
                    <form action="<?php echo U('addProp');?>" method="post" class="form-horizontal" role="form">
                      
                      <div class="form-group">
                        <label for="input01" class="col-sm-4 control-label">属性名称</label>
                        <div class="col-sm-8">
                          <input  class="form-control" id="input01" name="attr_name">
                        </div>
                      </div>

                      <div class="form-group">
                        <label for="input01" class="col-sm-4 control-label">分类名</label>
                        <div class="col-sm-8">
                            <select>
                                <option>请选择分类</option>
                                <?php if(is_array($cate)): foreach($cate as $key=>$v): ?><option name="cate_id" class="cate" value="<?php echo ($v['id']); ?>"><?php echo ($v['name']); ?></option><?php endforeach; endif; ?>
                            </select>
                        </div>
                      </div>
...
//     var val = $(this).val();
//     // alert(val);
//     $(this).after('<input value="'+val+'" name="cate_id">')
// })
